...
def main_zad1():
    while True:
        ...
        if choice == "1":
            print("Входные данные: 2 массива с числами одинакового размера.")
            print("Производится суммирование чисел из массивов.")
            print("Первый массив сортируется в порядке убывания, второй - в порядке возрастания.")
            print("Если числа в массивах совпадают, их сумма равна нулю.")
            print("Итоговый массив сортируется в порядке возрастания.")
