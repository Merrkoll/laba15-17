...
def main_zad4():
    while True:
        ...
        print("3. Сгенерировать случайным образом")
        print("4. Выполнить алгоритм")
        print("5. Вернуться в главное меню")
        sub_sub_choice = str(input("Введите пункт меню: "))
        if sub_sub_choice == "1":
            print("Входные данные: 2 массива с цифрами, каждый представляет собой большое число.")
            print("Нужно произвести сумму или разность массивов. ")
